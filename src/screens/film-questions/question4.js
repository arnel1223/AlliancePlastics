...
const Question4: () => React$Node = (props) => {
  ...
  const onUpdateQuestion = (value, index) => {
    ...
    if (index === 1) {
      nLength = nLength * 3.28084;
    }
    props.updateQuestion4(`${nLength} feet`);
  }
      ...
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center",}}>
        ...
        <ScrollPicker
          ...
          onValueChange={(value, index) => {
            ...
            if (index !== unitIndex) {
              if (index === 0) {
                nValue = nValue * 3.28084;
              } else {
                nValue = nValue * 0.3047999902464003;
              }
...
const mapDispatchToProps = {
  updateQuestion4: AppCreators.updateQuestion4,
};
